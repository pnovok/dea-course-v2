...
-- MAGIC %fs ls 's3://pnovok-demo-workspace-ext2/circuitbox/'
...
CREATE CATALOG IF NOT EXISTS circuitbox
  MANAGED LOCATION 's3://pnovok-demo-workspace-ext2/'
...
CREATE SCHEMA IF NOT EXISTS landing
   MANAGED LOCATION 's3://pnovok-demo-workspace-ext2/circuitbox/landing';

CREATE SCHEMA IF NOT EXISTS lakehouse
   MANAGED LOCATION 's3://pnovok-demo-workspace-ext2/circuitbox/lakehouse';

-- COMMAND ----------

USE CATALOG circuitbox;
DROP SCHEMA landing CASCADE;
...
CREATE EXTERNAL VOLUME IF NOT EXISTS operational_data
      LOCATION 's3://pnovok-demo-workspace-ext2/circuitbox/landing/operational_data';
